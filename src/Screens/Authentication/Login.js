...
export default function Login() {
  ...
  const [mobile, setMobile] = useState('9595057009');
  const [password, setPassword] = useState('9595057009');
    ...
    <>
      <View style={styles.container}>
        <View style={styles.authCard}>
          ...
          <Text style={{color: 'red', paddingLeft: 35}}>
            {errorNumber ? <Text>Number is required</Text> : ''}
          </Text>
          ...
          <Text style={{color: 'red', paddingLeft: 35}}>
            {errorPassword ? <Text>Password is required</Text> : ''}
          </Text>
          ...
          <View style={{alignItems: 'center'}}>
            ...
            <View
              ...
              <TouchableOpacity onPress={handleRegister}>
                <Text style={{color: globalColors.card, marginHorizontal: 5}}>
                  Sign Up
                </Text>
              </TouchableOpacity>
            </View>
